      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 py-12 border-b border-slate-800">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-300 font-light">
              <li><a href="#services" className="hover:text-[#0066FF] transition-colors">[01] Branding & Design</a></li>
              <li><a href="#services" className="hover:text-[#0066FF] transition-colors">[02] Digital Marketing</a></li>
              <li><a href="#services" className="hover:text-[#0066FF] transition-colors">[03] Content Creation</a></li>
              <li><a href="#services" className="hover:text-[#0066FF] transition-colors">[04] Web Design & Dev</a></li>
              <li><a href="#services" className="hover:text-[#0066FF] transition-colors">[05] Strategy & Consulting</a></li>
            </ul>
          </div>

          {/* Nav Col 2: Direct Contact */}
          ...
          {/* Nav Col 3: Back to Top */}
          <div className="md:col-span-2 flex flex-col justify-between items-start md:items-end">
            <button
              onClick={scrollToTop}
              className="p-3 rounded-full bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-white flex items-center gap-2 text-xs font-mono uppercase tracking-wider transition-all cursor-pointer group"
            >
              <span>{f.backToTop}</span>
              <ArrowUp className="w-4 h-4 text-[#0066FF] transition-transform group-hover:-translate-y-0.5" />
            </button>

            <span className="text-[11px] font-mono text-slate-500 mt-6 md:mt-0">
              KEEN AGENCY DIGITAL © {new Date().getFullYear()}
            </span>
          </div>
        </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-slate-500 gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="hover:text-white transition-colors">{f.refund}</a>
